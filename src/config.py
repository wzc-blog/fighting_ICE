...
# xqy:ֻ���޸�learner_params��'is_dueling'���ɿ����Ƿ�ʹ��duelingNet
learner_params = {'gamma': 0.9, 'lr': 0.001, 'is_double_dqn':True,'num_step': 3,'is_dueling':True}
trainer_params = {
...
policy_params = {
    ...
    'action_space_dim': 40,
    'hidden_size': 128,
    'is_dueling':learner_params['is_dueling']
}
